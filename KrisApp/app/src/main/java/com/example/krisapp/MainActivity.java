...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppCompatButton buttonVma = findViewById(R.id.buttonVma); //såhär kopplar man en knapp
        buttonVma.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, VMAACTIVITY.class); //såhär kopplar man en knapp
